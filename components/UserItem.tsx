...
import { Users, DeleteUserMutationFn, DeleteUserMutation, Exact } from '../types/generated/graphql';
...
export const UsersItem: VFC<Props> = memo(({
  user,
  delete_users_by_pk,
  setEditedUser,
}) => {
  console.log('UsersItem rendered')
  return (
    <div className='my-1'>
